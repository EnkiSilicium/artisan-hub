...
import { BonusEventNameEnum } from './bonus-event.registy';

import type { BonusEventName } from './bonus-event.registy';

export function makeBonusEvent(
  over: Partial<BonusEventEntity> = {},
): BonusEventEntity {
  ...
  Object.assign(event, {
    ...
    eventName:
      over.eventName ??
      (BonusEventNameEnum as Record<string, BonusEventName>).OrderCompleted ??
      'OrderCompleted',
